import { basicVertShader, halfToneFragShader } from "./shaders";
import { addGLToUpdate } from "./updateShaders";
import { createShader } from "./useShader";



export async function createHalfToneShader(name: string, speed: number){
    var temp = createShader(name, basicVertShader, halfToneFragShader);
    if (!temp) return;
