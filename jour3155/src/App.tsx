  ...
  return (
    <div className=' relative w-full h-fit overflow-clip font-serif text-[#282b2e]'>
      ...
      <div className=' flex flex-col justify-center items-center mt-5 ml-12 mr-12 lg:ml-[200px] lg:mr-[200px] gap-8 text-2xl font-thin'
        ...
        <p>Wong’s company has seen a rise of about 10% in the number of applicants in the past six months most of whom are mainlanders who came to Hong Kong through the TTPS.</p>
        ...
        <p>The local labor force has dropped 5.3% from 3.99 million in 2019 to 3.77 million in 2022, hitting a record low since the immigration wave and the COVID-19 pandemic, according to the Census and Statistics Department.</p>
